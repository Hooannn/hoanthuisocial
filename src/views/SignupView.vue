  ...
  <div class="signup-page">
    <form action="/">
      <div class="account">
        ...
        <input placeholder="Example@gmail.com" v-model="email" type="email" id="email" />
        <label for="password">Password:</label>
        <input placeholder="Your password must be at least 6 character" v-model="password" type="password" id="password" />
        ...
        <input placeholder="Enter your phone number" v-model="phone" type="text" id="phone" />
      </div>
      <div class="information">
        <h2><strong style="fontSize: 25px">Information:</strong></h2>
        <label for="username">Username:</label>
        <input placeholder="*Username" v-model="username" type="text" id="username" />
...
.signup-page form .account input::placeholder {
  color:rgba(255, 255, 255, 0.616);
}
.signup-page form .account input:focus {
  border-color: orange;
}
/* information */
...
.signup-page form .information select:focus {
  border-color: orange;
}
...
.signup-page form .information input:focus {
  border-color: orange;
}
